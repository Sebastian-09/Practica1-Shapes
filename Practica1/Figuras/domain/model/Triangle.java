...
public class Triangle extends Shape {
    ...
    @Override
    public int getArea() {
        return (int) (Math.sqrt((getPerimeter() / 2) * ((getPerimeter() / 2) - sideSize)
                * ((getPerimeter() / 2) - sideSize2) * ((getPerimeter() / 2) - sideSize3)));
    }
    ...
    public Triangle(int newX, int newY, int newSideSize, int newSideSize2, int newSideSize3) {
        super(newX, newY);
        setSideSize(newSideSize);
        setSideSize2(newSideSize2);
        setSideSize3(newSideSize3);
    }

    public Triangle(int newSideSize, int newSideSize2, int newSideSize3) {
        this(0, 0, newSideSize, newSideSize2, newSideSize3);
    }
